...
namespace AmazoniamWillowHotel.Models
{
    ...
    public partial class Hotel_Amazonian_WillowEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_getReservationInfo_Result> sp_getReservationInfo(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getReservationInfo_Result>("sp_getReservationInfo", idParameter);
        }
    
        public virtual ObjectResult<sp_getReservationInfo_Result> getReservationInfo(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getReservationInfo_Result>("getReservationInfo", idParameter);
        }
    }
}
